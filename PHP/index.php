...
<body>
    ...
    <br>
    <h1 class="bio-graph-heading" style="text-align:center; font-style: normal; padding: 40px 110px; font-size: 30px; font-weight: 600;">Dental Clinic Management System</h1>
    <br>
